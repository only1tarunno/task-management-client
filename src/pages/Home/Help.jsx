    ...
    <div className="bg-[#f8fafc] py-10 lg:py-16">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 pt-10">
          <div className="bg-[#e3defc] p-6 pr-10 rounded-2xl space-y-3">
          ...
          <div className="bg-[#dffdec] p-6 pr-10 rounded-2xl space-y-3">
          ...
          <div className="bg-[#fceedf] p-6 pr-10 rounded-2xl space-y-3">
